...
def test_set_platelets():
        assert str(set_platelets(372222)) == "High"
        assert str(set_platelets(158722)) == "Normal"


def test_set_eject_fract():
    assert str(set_eject_fract(59)) == "Normal"
    assert str(set_eject_fract(23)) == "Low"
